namespace ContossoU2018.Models
{
    public class Enrollment
    {
        ...
        /*
         *The EnrollmentID property will be the primary key: this entity used the ClassNameID pattern instead
         * of the ID by itself that you have in the Student Entity
         */
